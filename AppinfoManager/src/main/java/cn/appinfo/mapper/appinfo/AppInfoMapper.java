package cn.appinfo.mapper.appinfo;
...
public interface AppInfoMapper {
	 ...
	 * @return
	 */
	List<AppInfo> getAppInfoByCondition(@Param("appinfo") AppInfo appinfo, @Param("startRow") int startRow, @Param("pageSize") int pageSize);
